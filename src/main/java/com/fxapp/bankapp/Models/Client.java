...
public class Client {
    ...
    public StringProperty getPayeeAddressProperty() {
        return this.payeeAddress;
    }

    public ObjectProperty<Account> getCheckingAccountProperty() {
        return this.checkingAccount;
    }

    public ObjectProperty<Account> getSavingsAccountProperty() {
        return this.savingsAccount;
    }

    public ObjectProperty<LocalDate> getDateCreatedProperty() {
